...
-- CreateEnum
CREATE TYPE "EthnicityEnum" AS ENUM ('White', 'Black', 'AsianAmerican', 'EastAsian', 'SouthEastAsian', 'SouthAsian', 'MiddleEastern', 'Hispanic', 'Pacific');
...
-- CreateTable
CREATE TABLE "TainingImages" (
    "id" TEXT NOT NULL,
    "imageUrl" TEXT NOT NULL,
    "modelId" TEXT NOT NULL,

    CONSTRAINT "TainingImages_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "TainingImages" ADD CONSTRAINT "TainingImages_modelId_fkey" FOREIGN KEY ("modelId") REFERENCES "Model"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
